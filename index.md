...
<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 100px;">
  ...
  <div>
    <img src="/jem.jpg" style="width: 420px;">
  </div>

</div>

<div style="margin-top: 40px; display: flex; flex-direction: column; align-items: flex-end; line-height: 1;">
  ...
  <div style="font-size: 0.5em; margin-top: 8px;">
    © All rights reserved
  </div>
